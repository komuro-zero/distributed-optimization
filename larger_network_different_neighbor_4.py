...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.pg_extra_mc_consensus_violation(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,5.6/self.m,0.01,26.7,self.iteration,graph,w_all,10,1)
        self.pg_extra_mc_consensus_violation(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,5.6/self.m,0.01,26.7,self.iteration,graph,w_all,1,1)
        self.pg_extra_mc_consensus_violation(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,5.6/self.m,0.01,26.7,self.iteration,graph,w_all,0,1)
