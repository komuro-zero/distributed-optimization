...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.00023*self.m,0.002849,self.iteration)
        error,wcmc = self.centralized_mc_twin(U_all,d_all,w,w_star,L2,0.0253,0.002849,0.0585,self.iteration,self.m)
        ...
        plt.show()
        x = range(len(wcmc))
        plt.plot(x,wcmc,label = "centralized mc")
        plt.plot(x,wcl1,label = "centralized l1")
