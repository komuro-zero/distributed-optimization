...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.centralized_L1(U_all,d_all,w,w_star,L2,3,0.01,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,3.5,0.01,7.3,self.iteration)
