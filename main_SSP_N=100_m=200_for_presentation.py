...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        # error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.62,0.001,18,self.iteration)
        ...
        # self.pg_extra_l1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.24/self.m,0.001,0.09,self.iteration,graph,w_all)
