...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        # self.prox_dgd(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.9/self.m,1,2/self.m,self.iteration,graph,w_all)
        ...
        # self.pg_extra_l1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.19/self.m,0.02,0.09,self.iteration,graph,w_all,0,1)
        w,w_star,w_all,U_all,d_all,L2,graph = self.make_variables_noise_after_2(self.N,self.m,self.r_i,self.sparsity_percentage,self.how_weakly_sparse,self.w_noise,self.normal_distribution,self.w_zero)
        ...
        # self.pg_extra_mc_consensus_violation(U_   all,d_all,w_star,L2,self.N,self.m,self.r_i,2.2/self.m,0.02,0.09,self.iteration,graph,w_all,7)
        ...
        # self.pg_extra_mc_convex(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.2/self.m,0.088,0.0001,self.iteration,graph,w_all)
        ...
        plt.ylabel("Disagreement (dB)",fontsize=16)
        ...
        # plt.savefig('journal_system_mismatch_with_l1_SIP.pdf')
