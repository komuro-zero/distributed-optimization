...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.centralized_L1(U_all,d_all,w,w_star,L2,0.65,0.01,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.3,0.01,6.4,self.iteration)
