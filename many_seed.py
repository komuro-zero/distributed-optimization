...
from altered_distributed_function import functions
...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        #dgd = self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.25,self.iteration,c,w_all)
        #dl1 = self.distributed_L1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,10**-4,0.26,self.iteration,c,w_all)
