...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        dgd = self.distributed_gradient_descent_wj(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.25,self.iteration,c,w_all,cmc)
        dl1 = self.distributed_L1_wj(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,10**-4,0.26,self.iteration,c,w_all,cl1)
        dmc = self.distributed_mc_wj(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,self.lamb,self.eta,self.rho,self.iteration,c,w_all,cmc)
