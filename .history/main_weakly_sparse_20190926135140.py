...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        self.centralized_gradient_descent(U_all,d_all,w,w_star,L2,0.0026,self.iteration)
        ...
        self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.0375,self.iteration,c,w_all)
