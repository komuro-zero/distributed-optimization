...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        error,cgd = self.centralized_gradient_descent(U_all,d_all,w,w_star,L2,0.0036,self.iteration)
        ...
        self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.031,self.iteration,c,w_all)
