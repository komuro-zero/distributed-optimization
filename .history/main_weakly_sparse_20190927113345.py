...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        self.distributed_gradient_descent_wj(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.001,self.iteration,c,w_all,wcgd)
        ...
        self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.0011,self.iteration,c,w_all)
