...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        #error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.003,0.003,self.iteration)
        ...
        #self.distributed_mc_wj(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,self.lamb,self
        #   .eta,self.rho,self.iteration,c,w_all,wcmc)
        self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.11,self.iteration,c,w_all)
        self.distributed_L1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,10**-3,0.11,self.iteration,c,w_all)
        self.distributed_mc(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,self.lamb,self.eta,self.rho,self.iteration,c,w_all)
        self.distributed_mc(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,3*10**-3,self.eta,self.rho,self.iteration,c,w_all)
