...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        #cl1,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,10**-4,0.0036,self.iteration)
        #cmc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,5*10**-1,0.0036,5*10**-1*(23.57**2),self.iteration)
        ...
        return #w_star,w_star_noise,wcgd,wcl1,wcmc
...
if __name__ == "__main__":
    ...
    for i in range(1):
        w_star,w_star_noise,wcgd,wcl1,wcmc = simulation.run()
