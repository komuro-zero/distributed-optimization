...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.24,self.iteration,c,w_all)
        self.distributed_L1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,10**-17,0.222,self.iteration,c,w_all)
