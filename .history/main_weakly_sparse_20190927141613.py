...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.0031,0.0005,self.iteration)
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.0031,0.002,self.iteration)
        #error,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.0031,0.001,self.lamb*((1)**2),self.iteration)
        ...
        #self.distributed_gradient_descent(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.008,self.iteration,c,w_all)
