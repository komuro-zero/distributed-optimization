...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.00305,0.001,self.iteration)
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.003,0.001,self.iteration)
