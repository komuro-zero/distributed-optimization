...
class distributed_updates(functions):
    ...
    def run(self):
        ...
        error_cgd,wcgd = self.centralized_gradient_descent(U_all,d_a
        ll,w,w_star,L2,0.003,self.iteration)
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.05,0.003,self.iteration)
