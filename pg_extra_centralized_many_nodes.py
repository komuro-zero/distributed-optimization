...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        #N60 m100 ri80 noise20 1db
        error,wcl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.085,0.0012,self.iteration)
        error,wcmc = self.centralized_mc_twin(U_all,d_all,w,w_star,L2,0.09,0.0012,0.37,self.iteration,self.m)
        error,wcmc = self.centralized_mc_twin_nonconvex(U_all,d_all,w,w_star,L2,0.09,0.0012,0.15,self.iteration,self.m)
