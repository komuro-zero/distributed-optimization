...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.centralized_gradient_descent(U_all,d_all,w,w_star,L2,0.001,self.iteration)
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.5,0.001,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,2,0.001,151,self.iteration)
        ...
        # self.pg_extra_mc_consensus_violation(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.9/self.m,1,2/self.m,self.iteration,graph,w_all,5,1)

        # thresh = 0
        # for i in range(100):
        #     lamb = 0.1 + 0.1*i
        #     error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,lamb,0.001,self.iteration)
