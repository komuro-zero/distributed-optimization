...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        # self.pg_extra_mc_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.22/self.m,0.08,0.034,self.iteration,graph,w_all)
        # self.pg_extra_mc_consensus_violation_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.22/self.m,0.08,0.034,self.iteration,graph,w_all)
