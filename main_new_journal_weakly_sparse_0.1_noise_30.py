...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.01,0.01,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.1,0.01,1.6,self.iteration)
        # error_centralized_scad,wcmc = self.centralized_scad(U_all,d_all,w,w_star,L2,0.06,0.01,8.2,self.iteration)
        ...
        # self.pg_extra_l1(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.9/self.m,0.02,0.09,self.iteration,graph,w_all)
        # self.pg_extra_mc_consensus_violation(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,4.6/self.m,1,8.7/self.m,self.iteration,graph,w_all,0,1)
