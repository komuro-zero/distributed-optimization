...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.pg_extra_mc(U_all,d_all,wcmc,L2,self.N,self.m,self.r_i,2.2/self.m,0.02,0.09,self.iteration,graph,w_all)
        self.pg_extra_mc_consensus_violation(U_all,d_all,wcmc,L2,self.N,self.m,self.r_i,2.2/self.m,0.02,0.09,self.iteration,graph,w_all,1)
        ...
        # self.pg_extra_scad(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.1/self.m,0.02,5,self.iteration,graph,w_all)
        ...
        plt.ylabel("System Mismatch (dB)",fontsize=18)
