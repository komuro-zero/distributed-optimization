...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.29,0.001,1.9,100)
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.22,10,100)
        ...
        error_amc,wamc=self.pg_extra_approximate_mc(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.26/self.m,0.01,1.1/self.m,self.iteration,graph,w_all)
        I = np.eye(self.N)
