...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.0001,0.01,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.2,0.01,6.64,self.iteration)
        # thresh = 0
        # for i in range(100):
        #     lamb = 0.00001*i+0.00001
