...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,0.4,0.001,5.1,self.iteration)
        ...
        self.pg_extra_approximate_mc(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,0.98/self.m,0.02,4.5/self.m,self.iteration,graph,w_all)
        self.pg_extra_approximate_mc(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1/self.m,0.02,4.6/self.m,self.iteration,graph,w_all)
