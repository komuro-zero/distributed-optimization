...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        # plt.show()
        error_dgd,wdgd = self.centralized_gradient_descent(U_all,d_all,w,w_star,L2,0.007,self.iteration)
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,0.02,0.007,self.iteration)
        self.centralized_partial_mc(U_all,d_all,w,w_star,L2,0.02,0.01,0.05,self.iteration,self.m)
        ...
        # for i in range(10):
        #     lamb = 0.01+0.01*i
        #     error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,lamb,0.007,self.iteration)
        ...
        #         lamb =0.01+0.01*i
        #         rho = 0.01+0.01*j
        #         error_centralized_mc,wcmc = self.centralized_partial_mc(U_all,d_all,w,w_star,L2,lamb,0.007,rho,self.iteration,self.m)
