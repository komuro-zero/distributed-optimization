...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.02,0.09,self.iteration,graph,w_all,0,1)
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.02,0.09,self.iteration,graph,w_all,0.1,1)
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.02,0.09,self.iteration,graph,w_all,1,1)
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.03,0.09,self.iteration,graph,w_all,0,0.1)
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.03,0.09,self.iteration,graph,w_all,0.1,0.1)
        self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.03,0.09,self.iteration,graph,w_all,1,0.1)
        # self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.03,0.09,self.iteration,graph,w_all,0.5,0.1)
        # self.pg_extra_mixing_matrix_l1_consensus_graph(U_all,d_all,w_star,L2,self.N,self.m,self.r_i,1.2/self.m,0.03,0.09,self.iteration,graph,w_all,1,0.1)
