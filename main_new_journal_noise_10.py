...
class distributed_updates(update_functions):
    ...
    def run(self):
        ...
        error_l1,wl1 = self.centralized_L1(U_all,d_all,w,w_star,L2,1.9,0.01,self.iteration)
        error_centralized_mc,wcmc = self.centralized_mc(U_all,d_all,w,w_star,L2,4.6,0.01,8.7,self.iteration)
        error_centralized_scad,wcmc = self.centralized_scad(U_all,d_all,w,w_star,L2,0.07,0.01,6.5,self.iteration)
